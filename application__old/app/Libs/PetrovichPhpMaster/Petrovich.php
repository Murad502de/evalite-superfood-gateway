...
namespace App\Libs\PetrovichPhpMaster;
...
class Petrovich
{
    ...
    public function detectGender($middlename)
    {
        ...
        switch (mb_substr(mb_strtolower($middlename), -4)) {
            case 'оглы':return Petrovich::GENDER_MALE;
                break;
            case 'кызы':return Petrovich::GENDER_FEMALE;
                break;
        }

        switch (mb_substr(mb_strtolower($middlename), -2)) {
            case 'ич':return Petrovich::GENDER_MALE;
                break;
            case 'на':return Petrovich::GENDER_FEMALE;
                break;
            default:return Petrovich::GENDER_ANDROGYNOUS;
                break;
        }
    }
    ...
    {
        switch ($gender) {
            case 'male':return Petrovich::GENDER_MALE;
                break;
            case 'female':return Petrovich::GENDER_FEMALE;
                break;
            case 'androgynous':return Petrovich::GENDER_ANDROGYNOUS;
                break;
        }
    }
